// -------------------------------------------------------------
// 
// File Name: C:\Users\nievep\Downloads\Advanced VLSI Design\Project 1\REPO\Advanced-VLSI-Project-REPO\Project 1\MatlabFilterCalculation\codegen\LowpassFilter\hdlsrc\FilterTapSystolicPreAddWvlIn.v
...
// Source Path: LowpassFilter/dsphdl.FIRFilter/Filter/subFilter/FilterTapSystolicPreAddWvlIn
// Hierarchy Level: 4
// 
// -------------------------------------------------------------
...
module FilterTapSystolicPreAddWvlIn
  ...
  input   signed [43:0] addin;  // sfix44_En32
  input   dinRegVld;
  input   syncReset;
  output  signed [15:0] dinDly2;  // sfix16_En15
  output  signed [43:0] tapout;  // sfix44_En32
  ...
  reg signed [15:0] fTap_din1_reg3_next;  // sfix16_En15
  reg signed [15:0] fTap_din2_reg1_next;  // sfix16_En15
  reg signed [15:0] fTap_din2_reg2_next;  // sfix16_En15
  reg signed [43:0] fTap_addout_reg_next;  // sfix44_En32
  ...
  reg signed [43:0] tapout_1;  // sfix44_En32
  reg signed [16:0] fTap_add_cast;  // sfix17_En15
  reg signed [16:0] fTap_add_cast_0;  // sfix17_En15
  reg signed [16:0] fTap_add_temp;  // sfix17_En15
  reg signed [32:0] fTap_mul_temp;  // sfix33_En32
  reg signed [43:0] fTap_add_cast_1;  // sfix44_En32
